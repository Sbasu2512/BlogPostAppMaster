        ...
        <div className="col-span-1">
          <div className="mt-2 rounded outline outline-4 outline-offset-0 outline-amber-100 h-1/5">
            <div className="ml-2 p-4">
              <p className="font-mono"><strong>Home</strong>
              <br />
          ...
          <div className="mt-2 rounded outline outline-4 outline-offset-0 outline-amber-100 ">
            <span>
            <p className="font-mono ml-2">Profile Details</p>
            </span>
            <span>
                <p className="font-mono ml-2">Display Name: Lucifer</p>
                <p className="font-mono ml-2">Description: dfmdsklnsdklsnvds sklanfadsklfnasfklasnf lkaslkdnsld</p>
            </span>
          </div>
        </div>
        <div className="col-span-1"></div>
